...
public:
	...
	static bool compareLongByFirst32(I64 a, I64 b);
	static bool compareLongBySecond32(I64 a, I64 b);
};
...
public:
	...
	ID findValueByKey(ID key);
	void findValuesByKey(ID key, vector<ID> &startID);
	bool modifyValueByKey(ID key, ID value);
	...
	EntityIDBuffer* copy(EntityIDBuffer* otherBuffer);
