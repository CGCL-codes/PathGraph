		...
		int joinKey1, int joinKey2, int size1, int size2, char* flagVector1, char* flagVector2)
{
	...
	if ( IDCount1 == 1) {
		...
		*/
		qsort((I64*)&buffer1[0], size1, sizeof(I64), SortTask::qcompareLongByFirst32);
	} else if ( joinKey1 == 1) {
		/*
		std::sort((int64_t*)&buffer1[0], (int64_t*)&buffer1[size1 * 2], SortTask::compareLongBySecond32);
		*/
		qsort((I64*)&buffer1[0], size1, sizeof(I64), SortTask::qcompareLongBySecond32);
	}
	...
	if ( IDCount2 == 1 ) {
		...
		*/
		 qsort((I64*)&buffer2[0], size2, sizeof(I64), SortTask::qcompareLongByFirst32);
	} else if ( joinKey2 == 1 ) {
		/*
		std::sort((int64_t*)&buffer2[0], (int64_t*)&buffer2[size2 * 2], SortTask::compareLongBySecond32);
		*/
		 qsort((I64*)&buffer2[0], size2, sizeof(I64), SortTask::qcompareLongBySecond32);
	}
...
{
	return (ID)pow(2.0,(int)log((double)size) / log(10.0) + 2);
}

ID HashJoin::GetHashKey(ID size)
{
	return (ID)pow(2.0,(int)log((double)size / log(10.0)));
}
