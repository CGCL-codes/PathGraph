...
StringIDSegment* StringIDSegment::create(const string dir, const string segmentName)
{
	...
	if(segment->stringPool==NULL){
		MessageEngine::showMessage("create string pool error", MessageEngine::ERR);
		return NULL;
	}
	...
	if(segment->idStroffPool==NULL){
		MessageEngine::showMessage("create id string offset error", MessageEngine::ERR);
	...
	if(segment->stringHashTable==NULL){
		MessageEngine::showMessage("create string hash table error", MessageEngine::ERR);
		delete segment->stringPool;
...
StringIDSegment* StringIDSegment::load(const string dir, const string segmentName)
{
	...
	if(segment->stringPool == NULL) {
		MessageEngine::showMessage("load string pool error!", MessageEngine::ERR);
		return NULL;
	}
	...
	if(segment->idStroffPool == NULL) {
		delete segment->stringPool;
		MessageEngine::showMessage("load is string offset pool error", MessageEngine::ERR);
		return NULL;
	}
	...
	if(segment->stringHashTable == NULL) {
		delete segment->stringPool;
		delete segment->idStroffPool;
		MessageEngine::showMessage("load string hash talble error", MessageEngine::ERR);
		return NULL;
	}
