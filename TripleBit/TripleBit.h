...
#define TRIPLEBIT_WINDOWS
#else
#define TRIPLEBIT_UNIX
#endif

#if (defined(_WIN64) || defined(_LP64))
#define TRIPLEBIT_64BIT 1
#else
#define TRIPLEBIT_32BIT 1
#endif
...
//bitmap settings
const size_t INIT_PAGE_COUNT = 1024;
const size_t INCREMENT_PAGE_COUNT = 1024;
...
//thread pool
const unsigned int THREAD_NUMBER = 16; //should be 2^n;
