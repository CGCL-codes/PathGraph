...
//	gettimeofday(&start,NULL);
	...
	this->lexer = new SPARQLLexer(queryString);
	this->parser = new SPARQLParser(*lexer);
	try {
		this->parser->parse();
...
//	cout<<" time elapsed: "<<((end.tv_sec - start.tv_sec) * 1000000 + end.tv_usec - start.tv_usec ) / 1000000.0<<endl;
